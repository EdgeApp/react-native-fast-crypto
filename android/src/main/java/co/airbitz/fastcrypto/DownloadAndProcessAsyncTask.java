...
public class DownloadAndProcessAsyncTask extends android.os.AsyncTask<Void, Void, Void> {
    ...
    public DownloadAndProcessAsyncTask(String method, String jsonParams, Promise promise) {
        this.method = method;
